...
由于个人有骑行的爱好，经历过搬家，卖车买车多次，导致码表买了又卖又买，最后感觉很烦，于是打算做一款骑行路书的小程序，不走码表，只通过手机进行导航做路书规划
...
界面已按深色骑行主题重新设计。设计稿中尚未实现的收藏、多日行程、实时骑行和离线地图等能力，见 [UI 与功能路线图](docs/UI_ROADMAP.md)。
